...
export const env = Object.freeze({
  ...
  WORKER_TIMEOUT_MS: readPositiveInteger("WORKER_TIMEOUT_MS", 30 * 60 * 1000),
  ...
  JOB_RETENTION_MS: readPositiveInteger("JOB_RETENTION_MS", 30 * 60 * 1000),
  JOB_CLEANUP_INTERVAL_MS: readPositiveInteger("JOB_CLEANUP_INTERVAL_MS", 60_000),
  MAX_STORED_JOBS: readPositiveInteger("MAX_STORED_JOBS", 10)
});
